# Original from https://github.com/bethgelab/openimages2coco/blob/master/convert_annotations.py
# The original file is under MIT license by Bethge Lab
# Modification from: https://github.com/xingyizhou/UniDet/blob/master/tools/convert_datasets/convert_oid.py
# This file is under Apache Licence
# Check the second link if more dataset conversions to coco needed.
